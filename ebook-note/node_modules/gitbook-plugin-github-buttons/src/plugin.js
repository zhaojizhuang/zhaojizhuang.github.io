...
require(['gitbook'], function (gitbook) {
    ...
    function createUserButton({
        ...
        return `<a class="btn pull-right hidden-mobile" aria-label="github">
            <iframe style="display:inline-block;vertical-align:middle;" src="https://ghbtns.com/github-btn.html?user=${user}&type=follow&count=${count}&size=${size}" frameborder="0" scrolling="0" width="${width}px" height="${height}px"></iframe>
        </a>`;
    }
